    ...
    return (
        <View className='rounded-3xl border border-border bg-card p-4'>
            <View className='flex-row items-start gap-3'>
                <Pressable className='mt-1 size-6 items-center justify-center rounded-full
                ...
                <View className='flex-1'>
                    ...
                    <View className="mt-3 flex-row items-center gap-2">
                        ...
                        >
                            <Feather name="minus" size={12} color="#3b5a4a" />
                        </Pressable>
                        ...
                        >
                            <Feather name="plus" size={12} color="#3b5a4a" />
                        </Pressable>
                    </View>
                ...
                >
                    <Feather name="trash" size={13} color="#d45f58" />
                </Pressable>
            </View>
        </View>
    );
